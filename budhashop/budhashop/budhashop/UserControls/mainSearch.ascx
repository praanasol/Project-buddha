...
//                        },
    ...
    <asp:Panel ID="SearchUC" DefaultButton="searchBtn" runat="server">
     <div id="search_form"><asp:TextBox ID="SearchAll" runat="server"  CssClass="search_form_style" Text="Search Products.." onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;"></asp:TextBox></div>
