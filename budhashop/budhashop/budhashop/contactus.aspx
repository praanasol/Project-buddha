<%@ Page Language="C#" MasterPageFile="~/MasterPage/MainMaster.Master" AutoEventWireup="true" CodeBehind="contactus.aspx.cs" Inherits="budhashop.contactus" Title="Contact Page" %>
...
<div id="box_header" style="width:985px;">
    ...
    <div id="p_data_area" class="box_style" style="height:500px;">
        <div id="profileDiv">
            <!--Profile Start-->
            <aside id="p_data" class="p_f_box_style" style=" margin-top:120px;">
